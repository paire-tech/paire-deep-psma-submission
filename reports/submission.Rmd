...
Future work will extend this pipeline with uncertainty quantification, adaptive thresholding, 
and prospective multi-center validation. Ultimately, we aim to provide nuclear medicine 
physicians with a tool that is not only accurate but also interpretable, efficient, and ready for 
