...
# Step 2: Training
CUDA_VISIBLE_DEVICES=1 python scripts/02_train.py --dataset-id 902 --fold 0 -y
CUDA_VISIBLE_DEVICES=1 python scripts/02_train.py --dataset-id 902 --fold 1 -y
CUDA_VISIBLE_DEVICES=1 python scripts/02_train.py --dataset-id 902 --fold 2 -y
CUDA_VISIBLE_DEVICES=1 python scripts/02_train.py --dataset-id 902 --fold 3 -y
CUDA_VISIBLE_DEVICES=1 python scripts/02_train.py --dataset-id 902 --fold 4 -y