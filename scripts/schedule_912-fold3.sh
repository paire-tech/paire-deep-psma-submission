...
# CUDA_VISIBLE_DEVICES=1 python scripts/02_train.py --dataset-id 912 --fold 1 -y --plan nnUNetResEncUNetMPlans -y
# CUDA_VISIBLE_DEVICES=1 python scripts/02_train.py --dataset-id 912 --fold 2 -y --plan nnUNetResEncUNetMPlans -y
# CUDA_VISIBLE_DEVICES=2 python scripts/02_train.py --dataset-id 912 --fold 3 -y --plan nnUNetResEncUNetMPlans --trainer nnUNetTrainer_250epochs -y
CUDA_VISIBLE_DEVICES=2 python scripts/02_train.py --dataset-id 912 --fold 4 -y --plan nnUNetResEncUNetMPlans --trainer nnUNetTrainer_250epochs -y